 ...
 * @property User $user
 */
class Accolade extends \yii\db\ActiveRecord
{
    /**
     * {@inheritdoc}
     */
    ...
    public function rules()
    {
        return [
            ...
            [['giver_id'], 'exist', 'skipOnError' => true, 'targetClass' => User::className(), 'targetAttribute' => ['giver_id' => 'id']],
    ...
    {
        return $this->hasOne(User::className(), ['id' => 'giver_id']);
    }
